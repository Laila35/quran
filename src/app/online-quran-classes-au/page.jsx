...
/>
        ...
        <div>
          <div className="flex flex-col mt-8 lg:flex-row mx-4  xl:mx-32 2xl:mx-56">
           <div className="w-full lg:w-1/2 bg-opacity-5 px-5 rounded-[8px] flex flex-col   mr-8 justify-center">
          <LogoPortion  heading="Special Classes for Kids & Adults in Australia"  />
        </div>
