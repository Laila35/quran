  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Master Quran translation with certified scholars: 6-month certification program with live classes, weekly assessments, and personal feedback."
        />
        <meta
          name="keywords"
          content="Quran Translation Certification, Online Tafsir Course, Quranic Arabic Translation, Understand Quran Word Meanings, Islamic Translation Program, Quran Exegesis Classes"
        />
        ...
        <div className="container mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-2/3 order-2 lg:order-1">
            <div className="bg-gray-100 rounded-lg shadow-lg p-8">
              ...
              <p className="text-base font-medium pt-3">The Quran Translation Course includes:</p>
              <ul className="list-disc ml-8 space-y-1 pt-3">
