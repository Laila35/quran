...
const Register = () => {
  ...
  return (
    <>
      <ToastContainer />
      <div className="font-bold text-[18px] md:text-lg lg:text-[28px] text-black mb-8 text-center">
  Free Trial Class
</div>
  ...
  <button
    ...
    type="submit"
    disabled={loading}
    className="w-full p-3 font-semibold bg-gradient-to-r from-[#006d5b] to-[#2a8e76] text-white rounded-lg shadow-lg hover:shadow-2xl hover:bg-gradient-to-r hover:from-[#2a8e76] hover:to-[#006d5b] transition-all duration-500 ease-in-out transform hover:-translate-y-0.5"
  >
