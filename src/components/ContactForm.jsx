    ...
    const fetchCourses = async () => {
      try {
        ...
        if (response.data?.courses?.length > 0) {
          ...
          // Set default courses if none are found
          setCourses([
          ...
          toast.warning("Using default course list");
        ...
        // Don't show error toast if we're using default data
              ...
              <Form>
                ...
                <div className="mb-4">
                  <div className="relative flex items-center">
                    <FaUser className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-900" />
                    <input
                      type="text"
                      name="name"
                ...
                <div className="mb-4">
                  <div className="relative flex items-center">
                    <FaEnvelope className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-900" />
                    <input
                      type="email"
                      name="email"
                ...
                {/* Country Field */}
                <div className="mb-4 relative flex items-center">
                  <FaGlobe className="absolute left-4 top-1/2  transform  -translate-y-1/2 text-gray-900" />
                  <select
                    name="country"
                ...
                {/* Message Field */}
                <div className="mb-4 relative flex items-center">
                  <FaRegComment className="absolute left-4 top-1/3 transform -translate-y-1/2 text-gray-900" />
                  <textarea
                    name="message"
          ...
          <div className="flex flex-col gap-6 mb-8">
            <div className="relative flex flex-col">
              ...
              <input
                ...
                className="w-full py-3 pl-4 pr-4 text-[13px] rounded-md bg-grey border border-grey focus:border-blue-500 focus:ring-0 focus:bg-white placeholder:text-gray-900"
